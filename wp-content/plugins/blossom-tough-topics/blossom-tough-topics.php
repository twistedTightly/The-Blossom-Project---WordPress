	...
	class blm_tough_topics_widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			<div id="tough-topics-wrapper" class="sidebar-widget">
				...
				<p class="tough-topic-content minor-text">Especially during adolescence, our bodies go through a lot of changes that we may not be ready for. In this section we’ll go through all the changes we face as we become women during <em>puberty</em>, as well as basic information about <em>maintaining a healthy lifestye</em>.</p>
				<h2 class="section-header">Mental Health</h2>
				<p class="tough-topic-content minor-text">With our bodies and our lives constantly changing during adolescence, its often hard to maintain focus and a positive outlook, among other things. In this section we go over <em>ways to cope</em> with all these changes, <em>information about common psychological disorders</em> seen in young girls, and <em>people who can help</em>.</p>
				<h2 class="section-header">Getting Help</h2>
				<p class="tough-topic-content minor-text">While we’re giving you all the information we can regarding these topics, some questions and problems are too big for Blossom. If you’ve found that you’re questions aren’t being answered here, you are depressed or have had suicidal thoughts or actions, or just really need to talk out your issues with someone, we can help direct you where you need to go. There are plenty of <em>hotlines</em>, <em>groups</em>, <em>organizations</em>, and <em>programs</em> out there to help.</p>
			</div>
